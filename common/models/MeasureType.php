...
class MeasureType extends PoliterModel
{
    ...
    const ALARM = '3A29ACDE-6422-4394-AC9D-7EC8654C7D81';
    const PRESSURE_DIFF = '7C97D0DD-1036-43BC-8917-DD985DF8077B';
    const TIME = 'CB7F31D6-B1E1-4799-8D4F-B65401A8E6B6';
    const TEMPERATURE_HOT_WATER = '09C1D6A4-0AEE-408A-9335-FF5DD4AAC16B';
    const WORKING_TIME = '7938CDDD-654C-4FC4-A973-5F1606E1D406';
    const HEAT_FLOW = 'F35FAC49-E9E1-4470-B7A4-662FC94079DD';

    const TEMPERATURE_AIR = 'F96FBDF5-2F57-460A-9856-5558928DD455';
