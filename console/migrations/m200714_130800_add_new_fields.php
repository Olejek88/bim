...
class m200714_130800_add_new_fields extends Migration
{
    ...
    public function safeUp()
    {
        ...
        self::insertRefs('parameter-type', 'Цель потребления', ParameterType::TARGET_CONSUMPTION);
        self::insertRefs('parameter-type', 'Энергоэффективность', ParameterType::ENERGY_EFFICIENCY);
        self::insertRefs('parameter-type', 'Энергооснащенность', ParameterType::POWER_EQUIPMENT);
        ...
        self::insertRefs(self::EVENT_TYPE, 'Утепление черных полов в деревянных домах', null);
        self::insertRefs(self::EVENT_TYPE, 'Оснащение зданий общедомовыми приборами учета тепла, воды, электроэнергии', null);
        ...
        self::insertRefs(self::EVENT_TYPE, 'восстановление теплоснабжения лестничных площадок', null);
        ...
        self::insertRefs(self::EVENT_TYPE, 'оценка аварийности и потерь в тепловых, электрических и водопроводных сетях', null);


        self::insertRefs(self::EVENT_TYPE, 'замена старых окон на современные, обладающие повышенным термическим сопротивлением', null);
