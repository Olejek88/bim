<?php
/* @var $searchModel frontend\models\ActionRegisterSearch */
...
$this->title = Yii::t('app', 'ПолиТЭР::Журнал действий');
    ...
    <div class="row" style="margin-bottom: 8px; width:100%">
        <div class="col-sm-4" style="width:36%">
            ...
            echo $form->field($searchModel, 'createTimeStart')->widget(DatePicker::class, [
                'removeButton' => false,
                'pjaxContainerId' => 'action-register',
                'options' => [
                    'class' => 'add-filter',
                ],
                'pluginOptions' => [
...
echo GridView::widget([
    ...
    'panel' => [
        ...
        'heading' => '<i class="fa fa-list"></i>&nbsp; ' . Yii::t('app', 'Журнал действий')
    ]
]);
